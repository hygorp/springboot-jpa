...
import com.hygorp.spring.entities.Payment;
import com.hygorp.spring.entities.Product;
import com.hygorp.spring.entities.User;
import com.hygorp.spring.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p6 = new Product(null, "Anjo da Morte", "Cras fringilla convallis sem vel faucibus.", 44.99, "");
